      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-primary-content">Welcome back</h1>
            <p className="text-sm text-gray-600 mt-1">Log in to continue helping <span className="text-secondary font-semibold">ZeroWasteBite</span></p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <Link to="/forgot" className="text-xs text-secondary hover:text-secondary-dark font-medium">Forgot password?</Link>
              </div>
            </div>
